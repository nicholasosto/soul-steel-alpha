 ...
 * @since 1.0.0
 * @lastUpdated 2025-08-01 - Renamed from HealthBar to ResourceBar for clarity
 */
...
/**
 * Creates a resource bar component with health, mana, and stamina bars
 */
export function ResourceBar(props: ResourceBarProps): Frame {
